<x-layout.app :title="'Batam Campus Expo'" :nohp="$nohp" :lokasi="$lokasi">
        ...
        <div class="relative z-10 w-full h-full flex items-center">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8 text-center">
                ...
                <div class="mb-8 sm:mb-10 lg:mb-12 pt-4 lg:pt-8 headline-animate opacity-0">
                    <h1 class="font-sancreek uppercase text-[#D32F2F] leading-[0.85] text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl mb-3 lg:mb-4 [text-shadow:_3px_3px_0_rgba(0,0,0,0.8),_6px_6px_0_rgba(0,0,0,0.6),_0_0_20px_rgba(166,30,34,0.5)] headline-main">
                        BATAM</h1>
                    <h2 class="font-sancreek uppercase text-[#D32F2F] leading-[0.85] text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl [text-shadow:_3px_3px_0_rgba(0,0,0,0.8),_6px_6px_0_rgba(0,0,0,0.6),_0_0_20px_rgba(166,30,34,0.5)] headline-main">
                        CAMPUS EXPO</h2>
                    ...
                    <div class="mt-6 sm:mt-8 lg:mt-10 mb-8 sm:mb-10 lg:mb-12">
                        <a href="https://www.google.com/maps/search/?api=1&query=Pollux+Mall+Batam+Centre" target="_blank"
                            ...
                            <svg class="w-4 h-4 sm:w-5 sm:h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9z" />
                            </svg>
                            {{ $lokasi }}
                        </a>
                    </div>
                ...
                <!-- COUNTDOWN -->
                <div class="relative w-full flex justify-center items-center my-8 sm:my-10 lg:my-12 timer-animate opacity-0">
                    <div class="absolute w-full max-w-[400px] sm:max-w-[480px] lg:max-w-[520px] h-auto z-[1] pointer-events-none top-1/2 -translate-y-1/2">
                    ...
                    <div class="relative z-[2] p-4 sm:p-6 lg:p-8 w-full">
                        <div class="flex justify-center items-center mb-3 sm:mb-4">
                            <div class="font-sancreek text-[#A61E22] drop-shadow-[0_0_10px_rgba(166,30,34,0.5)] text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl mx-1 sm:mx-2" id="days">0</div>
                            <div class="font-sancreek text-[#A61E22] drop-shadow-[0_0_10px_rgba(166,30,34,0.5)] text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl">:</div>
                            <div class="font-sancreek text-[#A61E22] drop-shadow-[0_0_10px_rgba(166,30,34,0.5)] text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl mx-1 sm:mx-2" id="hours">00</div>
                            <div class="font-sancreek text-[#A61E22] drop-shadow-[0_0_10px_rgba(166,30,34,0.5)] text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl">:</div>
                            <div class="font-sancreek text-[#A61E22] drop-shadow-[0_0_10px_rgba(166,30,34,0.5)] text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl mx-1 sm:mx-2" id="minutes">00</div>
                            <div class="font-sancreek text-[#A61E22] drop-shadow-[0_0_10px_rgba(166,30,34,0.5)] text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl">:</div>
                            <div class="font-sancreek text-[#A61E22] drop-shadow-[0_0_10px_rgba(166,30,34,0.5)] text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl mx-1 sm:mx-2" id="seconds">00</div>
                        </div>
                        <div class="flex justify-center gap-3 sm:gap-4 lg:gap-6 text-xs sm:text-sm md:text-base font-sancreek text-[#A61E22] drop-shadow-[0_0_10px_rgba(166,30,34,0.5)]">
                            <span>Hari</span>
                            <span>Jam</span>
                            <span>Menit</span>
                            <span>Detik</span>
    ...
    <!-- SECTION INFO -->
    <section class="relative w-full pt-4 sm:pt-6 lg:pt-8 pb-16 sm:pb-20 lg:pb-24 bg-gradient-to-b from-[#EFE4B7] via-[#FBE99C] to-[#FDDC57] overflow-hidden z-20">
                ...
                <defs>
                    ...
                    <pattern id="carnivalCards" x="0" y="0" width="150" height="200" patternUnits="userSpaceOnUse">
                        ...
                        <g transform="translate(15, 20) rotate(15)">
                            <rect width="35" height="50" rx="4" fill="#D32F2F" stroke="#B71C1C" stroke-width="1"/>
                            ...
                            <text x="28" y="45" font-size="6" fill="white" font-weight="bold" transform="rotate(180 28 45)">A</text>
                        </g>
                        
                        <!-- Heart Card (White with Red Hearts) -->
                        <g transform="translate(80, 10) rotate(-10)">
                            <rect width="35" height="50" rx="4" fill="white" stroke="#D32F2F" stroke-width="2"/>
                            <path d="M17.5 15 C14 12, 8 12, 11 20 C8 12, 2 12, 5 20 L17.5 28 L30 20 C27 12, 21 12, 24 20 C21 12, 15 12, 17.5 15 Z" fill="#D32F2F"/>
                            <text x="3" y="10" font-size="6" fill="#D32F2F" font-weight="bold">K</text>
                            <text x="28" y="45" font-size="6" fill="#D32F2F" font-weight="bold" transform="rotate(180 28 45)">K</text>
                        </g>
                        
                        <!-- Diamond Card (Golden) -->
                        <g transform="translate(40, 80) rotate(25)">
                            <rect width="35" height="50" rx="4" fill="#fbbf24" stroke="#f59e0b" stroke-width="2"/>
                            <path d="M17.5 12 L25 20 L17.5 28 L10 20 Z" fill="white"/>
                            <text x="3" y="10" font-size="6" fill="white" font-weight="bold">Q</text>
                            <text x="28" y="45" font-size="6" fill="white" font-weight="bold" transform="rotate(180 28 45)">Q</text>
                        </g>
                        
                        <!-- Club Card (White with Black Clubs) -->
                        <g transform="translate(100, 120) rotate(-20)">
                            <rect width="35" height="50" rx="4" fill="white" stroke="#333" stroke-width="2"/>
                            ...
                            <text x="28" y="45" font-size="6" fill="#333" font-weight="bold" transform="rotate(180 28 45)">J</text>
                        </g>
                        
                        <!-- Joker Card (Purple) -->
                        <g transform="translate(10, 140) rotate(8)">
                            <rect width="35" height="50" rx="4" fill="#8B5CF6" stroke="#7C3AED" stroke-width="2"/>
                        ...
                        <g transform="translate(5, 100) rotate(-30)">
                            <rect width="12" height="18" rx="2" fill="white" stroke="#D32F2F" opacity="0.9"/>
        ...
        <div class="absolute top-16 left-8 w-10 h-14 bg-white rounded-md shadow-lg transform rotate-12 opacity-30 z-5 animate-pulse">
            <div class="p-1 text-center">
                <div class="text-xs text-red-600 font-bold">A♠</div>
            </div>
        </div>
        <div class="absolute top-40 right-16 w-10 h-14 bg-red-600 rounded-md shadow-lg transform -rotate-6 opacity-35 z-5" style="animation: float 4s ease-in-out infinite;">
            <div class="p-1 text-center">
                <div class="text-xs text-white font-bold">K♥</div>
            </div>
        </div>
        <div class="absolute bottom-32 left-1/4 w-10 h-14 bg-yellow-400 rounded-md shadow-lg transform rotate-45 opacity-25 z-5" style="animation: float 5s ease-in-out infinite; animation-delay: 1s;">
            <div class="p-1 text-center">
                <div class="text-xs text-white font-bold">Q♦</div>
            </div>
        </div>
        <div class="absolute top-1/2 right-12 w-10 h-14 bg-white rounded-md shadow-lg transform -rotate-12 opacity-40 z-5" style="animation: float 3.5s ease-in-out infinite; animation-delay: 2s;">
            <div class="p-1 text-center">
                <div class="text-xs text-black font-bold">J♣</div>
            </div>
        </div>
        <div class="absolute bottom-16 right-1/3 w-10 h-14 bg-purple-600 rounded-md shadow-lg transform rotate-20 opacity-30 z-5 animate-bounce" style="animation-delay: 0.5s;">
            <div class="p-1 text-center">
        ...
        <div class="absolute top-24 left-1/3 w-8 h-12 bg-green-500 rounded-md shadow-md transform -rotate-25 opacity-25 z-5" style="animation: float 6s ease-in-out infinite; animation-delay: 3s;">
            <div class="p-0.5 text-center">
                <div class="text-[8px] text-white font-bold">10♠</div>
            </div>
        </div>
        <div class="absolute bottom-40 left-16 w-8 h-12 bg-blue-500 rounded-md shadow-md transform rotate-35 opacity-20 z-5" style="animation: float 4.5s ease-in-out infinite; animation-delay: 1.5s;">
            <div class="p-0.5 text-center">
                <div class="text-[8px] text-white font-bold">9♦</div>
            </div>
        </div>
        <div class="absolute top-32 right-1/4 w-8 h-12 bg-orange-500 rounded-md shadow-md transform -rotate-15 opacity-35 z-5" style="animation: float 5.5s ease-in-out infinite; animation-delay: 2.5s;">
            <div class="p-0.5 text-center">
        ...
        <div class="absolute top-12 left-20 w-3 h-3 bg-yellow-400 rounded-full shadow-lg opacity-60 z-5" style="animation: pulse 2s infinite; animation-delay: 0s;"></div>
        <div class="absolute top-20 right-24 w-3 h-3 bg-red-500 rounded-full shadow-lg opacity-70 z-5" style="animation: pulse 2.5s infinite; animation-delay: 0.5s;"></div>
        <div class="absolute bottom-24 left-32 w-3 h-3 bg-blue-400 rounded-full shadow-lg opacity-65 z-5" style="animation: pulse 1.8s infinite; animation-delay: 1s;"></div>
        <div class="absolute bottom-12 right-40 w-3 h-3 bg-green-400 rounded-full shadow-lg opacity-55 z-5" style="animation: pulse 2.2s infinite; animation-delay: 1.5s;"></div>
        <div class="absolute top-1/2 left-12 w-3 h-3 bg-purple-400 rounded-full shadow-lg opacity-60 z-5" style="animation: pulse 1.5s infinite; animation-delay: 2s;"></div>
        <div class="absolute top-1/3 right-12 w-3 h-3 bg-orange-400 rounded-full shadow-lg opacity-75 z-5" style="animation: pulse 2.8s infinite; animation-delay: 0.8s;"></div>
        
        <!-- Background Elements (existing) -->
        <img src="{{ asset('images/balloon.svg') }}" class="absolute left-6 sm:left-8 lg:left-12 top-16 sm:top-20 lg:top-24 w-12 sm:w-14 lg:w-16 md:w-20 opacity-90 z-5" alt="balloon">
        <img src="{{ asset('images/balloon.svg') }}" class="absolute right-8 sm:right-10 lg:right-16 top-24 sm:top-32 lg:top-40 w-10 sm:w-12 lg:w-14 md:w-16 opacity-80 z-5" alt="balloon">
        <img src="{{ asset('images/GajahKiri.svg') }}" class="absolute left-0 bottom-0 w-16 sm:w-20 lg:w-24 md:w-36 z-5" alt="elephant left">
        <img src="{{ asset('images/GajahKanan.svg') }}" class="absolute right-0 bottom-0 w-16 sm:w-20 lg:w-24 md:w-40 z-5" alt="elephant right">
        ...
        <div class="relative container mx-auto px-4 sm:px-6 lg:px-8 pt-16 sm:pt-20 lg:pt-24 z-10">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16 lg:gap-20 items-start">
                <!-- KIRI : JUDUL -->
                <div>
                    <h2 class="font-sancreek uppercase text-[#D32F2F] leading-[0.85] text-4xl sm:text-5xl md:text-6xl lg:text-7xl [text-shadow:_3px_3px_0_rgba(0,0,0,0.8),_6px_6px_0_rgba(0,0,0,0.6),_0_0_20px_rgba(166,30,34,0.5)]">
            ...
            <div class="mt-16 sm:mt-20 lg:mt-24 text-center">
                <h3 class="font-sancreek uppercase text-[#D32F2F] text-3xl sm:text-4xl md:text-5xl mb-8 sm:mb-10 lg:mb-12 [text-shadow:_3px_3px_0_rgba(0,0,0,0.8),_6px_6px_0_rgba(0,0,0,0.6),_0_0_20px_rgba(166,30,34,0.5)]">
...
<section class="relative w-full py-16 overflow-hidden z-10"
    ...
    <div class="relative container mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        <div class="text-center mb-8 sm:mb-10 lg:mb-12">
            <h2 class="font-sancreek uppercase text-white text-3xl sm:text-4xl md:text-5xl p-3 sm:p-4 bg-red-700 rounded-md inline-block shadow-lg tracking-wide">
        ...
        <div class="max-w-4xl mx-auto space-y-4 sm:space-y-6">
            @php
                $faqs = [
                    [
                        ...
                        'answer' => 'Batam Campus Expo adalah pameran pendidikan terbesar di Kepulauan Riau yang menghadirkan berbagai universitas dan perguruan tinggi terbaik dari seluruh Indonesia. Acara ini bertujuan untuk membantu siswa SMA/SMK menemukan jurusan dan kampus yang tepat.'
                    ],
                    [
                        'question' => 'Kapan dan di mana Batam Campus Expo dilaksanakan?',
                        'answer' => 'Batam Campus Expo 2026 akan dilaksanakan pada ' . \Carbon\Carbon::parse($end_event)->format('d F Y') . ' di ' . e($lokasi) . '. Acara berlangsung dari pukul 09:00 - 21:00 WIB.'
                    ],
                    [
                        'question' => 'Apakah kegiatan ini berbayar?',
                        'answer' => 'Tidak, tiket masuk Batam Campus Expo sepenuhnya GRATIS! Namun, peserta wajib mendaftar terlebih dahulu secara online untuk mendapatkan tiket elektronik yang akan dipindai saat masuk.'
                    ],
                    [
                        'question' => 'Apa saja yang bisa didapatkan di expo?',
                        'answer' => 'Pengunjung dapat: konsultasi langsung dengan perwakilan kampus, informasi program studi dan beasiswa, seminar pendidikan, workshop karir, doorprize menarik, serta kesempatan mendaftar langsung dengan potongan biaya masuk.'
                    ]
                ];
            @endphp
            ...
            @foreach ($faqs as $index => $faq)
                <div class="relative cursor-pointer" onclick="toggleFAQ({{ $index }})">
                    ...
                    <div class="flex items-center justify-between bg-yellow-400 border-4 border-yellow-600 rounded-r-full px-4 sm:px-6 py-3 sm:py-4 shadow-lg transition-colors duration-300">
                        <span class="font-bold text-gray-800 text-base sm:text-lg md:text-xl flex-grow pr-2 sm:pr-4">{{ $faq['question'] }}</span>
                        <svg id="arrow-{{ $index }}" class="w-4 h-4 sm:w-5 sm:h-5 text-gray-800 flex-shrink-0 transition-transform duration-300" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div class="text-center mt-8 sm:mt-10">
                <button id="show-more-faq" class="bg-yellow-500 hover:bg-yellow-600 text-gray-800 font-bold py-3 px-6 sm:py-3 sm:px-8 rounded-full transition-all duration-300 shadow-lg">
                    More Questions?
                </button>
            </div>
        </div>
...
<section class="relative w-full overflow-hidden z-10" style="background-image: url('{{ asset('images/bgkontak.svg') }}'); background-size: cover; background-position: center; background-repeat: no-repeat;" >
    <!-- Decorative Elements -->
    <img src="{{ asset('images/balloon.svg') }}" class="absolute left-6 sm:left-8 lg:left-10 top-8 sm:top-10 lg:top-12 w-12 sm:w-14 lg:w-16 opacity-70" alt="balloon">
    <img src="{{ asset('images/balloon.svg') }}" class="absolute right-8 sm:right-10 lg:right-12 bottom-16 sm:bottom-20 lg:bottom-24 w-10 sm:w-12 lg:w-14 opacity-60" alt="balloon">
    
    <div class="relative container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16 z-10">
        <!-- Section Title -->
        <div class="text-center mb-12 sm:mb-16">
            <h2 class="font-sancreek uppercase text-[#D32F2F] text-4xl sm:text-5xl md:text-6xl mb-4 sm:mb-6 [text-shadow:_2px_2px_0_rgba(0,0,0,0.8),_4px_4px_0_rgba(0,0,0,0.6)]">
                Kontak & Lokasi
            </h2>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 max-w-6xl mx-auto">
            ...
            <div class="space-y-6 sm:space-y-8">
                ...
                <div class="bg-white/90 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-xl">
                    <h3 class="text-xl sm:text-2xl font-bold text-[#D32F2F] mb-4 sm:mb-6 pb-3 sm:pb-4 border-b border-gray-200">Informasi Kontak</h3>
                    ...
                    <div class="space-y-4 sm:space-y-6">
                        ...
                        <div class="flex items-center gap-3 sm:gap-4">
                            ...
                            <div>
                                ...
                                <a href="tel:{{ preg_replace('/[^0-9]/', '', $nohp) }}" class="text-gray-600 hover:text-[#D32F2F] transition-colors text-sm sm:text-base">
                                    {{ $nohp }}
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-3 sm:gap-4">
                            ...
                            <div>
                                ...
                                <a href="mailto:info@batamcampuseexpo.com" class="text-gray-600 hover:text-[#D32F2F] transition-colors text-sm sm:text-base">
                        ...
                        <div class="flex items-center gap-3 sm:gap-4">
                            ...
                            <div>
                                ...
                                <a href="https://instagram.com/batamcampuseexpo" target="_blank" class="text-gray-600 hover:text-[#D32F2F] transition-colors text-sm sm:text-base">
                                    @batamcampuseexpo
                                </a>
                            </div>
                        </div>
                ...
                <!-- Send Message Form -->
                <div class="bg-white/90 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-xl">
                    <h3 class="text-xl sm:text-2xl font-bold text-[#D32F2F] mb-4 sm:mb-6 pb-3 sm:pb-4 border-b border-gray-200">Kirim Pesan</h3>
            ...
            <div class="space-y-6 sm:space-y-8">
                <!-- Location Card -->
                <div class="bg-white/90 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-xl">
                    <h3 class="text-xl sm:text-2xl font-bold text-[#D32F2F] mb-4 sm:mb-6 pb-3 sm:pb-4 border-b border-gray-200">Lokasi Event</h3>
                    ...
                    <div class="space-y-4 sm:space-y-6">
                        ...
                        <div class="text-center">
                            <a href="https://www.google.com/maps/dir//{{ urlencode($lokasi) }}" 
                               target="_blank"
...
.hero-section > div:first-child {
    display: none; /* Hide the blue background div */
}
...
.hero-section::before {
    content: '';
    position: absolute;
    top: -150px; /* Extend further above navbar */
    left: 0;
    right: 0;
    bottom: 0;
    background: inherit;
