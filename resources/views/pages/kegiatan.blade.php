<x-layout.app :title="'Kegiatan - Batam Campus Expo'" :nohp="$nohp ?? '+62 812-3456-7890'" :lokasi="$lokasi ?? 'Pollux Mall Batam Centre'">
                ...
                <defs>
                    ...
                    <pattern id="circusPattern" x="0" y="0" width="200" height="250" patternUnits="userSpaceOnUse">
                        ...
                        <g transform="translate(120, 40)">
                            <circle cx="30" cy="30" r="25" fill="none" stroke="#fbbf24"
                                stroke-width="3" />
                            ...
                            <line x1="30" y1="30" x2="30" y2="5" stroke="#333"
                                stroke-width="1" />
                            <line x1="30" y1="30" x2="55" y2="30" stroke="#333"
                                stroke-width="1" />
                            <line x1="30" y1="30" x2="30" y2="55" stroke="#333"
                                stroke-width="1" />
                            <line x1="30" y1="30" x2="5" y2="30" stroke="#333"
                                stroke-width="1" />
                        </g>

                        <!-- Playing Cards -->
                        <g transform="translate(10, 120) rotate(15)">
                            <rect width="25" height="35" rx="3" fill="white" stroke="#D32F2F"
                                stroke-width="2" />
                            <path
                                d="M12.5 8 C10 6, 6 6, 8 12 C6 6, 2 6, 4 12 L12.5 18 L21 12 C19 6, 15 6, 17 12 C15 6, 11 6, 12.5 8 Z"
                                fill="#D32F2F" />
                        ...
                        <g transform="translate(140, 140) rotate(-20)">
                            <rect width="25" height="35" rx="3" fill="#8B5CF6" stroke="#7C3AED"
                                stroke-width="2" />
                        ...
                        <g transform="translate(60, 180)">
                            <rect width="20" height="20" rx="2" fill="white" stroke="#333"
                                stroke-width="2" />
                        ...
                        <g transform="translate(160, 200)">
                            <ellipse cx="15" cy="12" rx="12" ry="8" fill="#FFD700"
                        ...
                        <g transform="translate(40, 200)">
                            ...
                            <line x1="5" y1="16" x2="8" y2="25" stroke="#333"
                                stroke-width="1" />
                            <line x1="12" y1="14" x2="8" y2="25" stroke="#333"
                                stroke-width="1" />
                            <line x1="19" y1="18" x2="8" y2="25" stroke="#333"
                                stroke-width="1" />
                        </g>
                    </pattern>

                    <!-- Floating Lights -->
                    <pattern id="floatingLights" x="0" y="0" width="100" height="100"
    ...
    <section class="relative min-h pt-5 flex items-center z-10 bg-gradient-to-br">
        ...
        <div class="absolute top-16 left-8 w-16 h-20 bg-white rounded-lg shadow-2xl transform rotate-12 opacity-40 z-5"
        ...
        <div class="absolute top-32 right-16 w-16 h-20 bg-purple-600 rounded-lg shadow-2xl transform -rotate-6 opacity-50 z-5"
        ...
        <div class="absolute bottom-32 left-1/4 w-12 h-12 bg-yellow-400 rounded-full shadow-2xl opacity-60 z-5 flex items-center justify-center"
            style="animation: bounce 3s ease-in-out infinite; animation-delay: 0.5s;">
            <div class="text-white font-bold text-lg">🎪</div>
        </div>

        <div class="absolute top-1/2 right-12 w-14 h-14 bg-gradient-to-br from-red-500 to-pink-500 rounded-full shadow-2xl opacity-70 z-5 flex items-center justify-center"
        ...
        <div class="relative z-10 w-full h-full flex items-center">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
                ...
                <div class="mb-8">
                    <h1
                        class="font-sancreek uppercase text-white leading-[0.85] text-5xl sm:text-6xl md:text-7xl lg:text-8xl mb-4 [text-shadow:_4px_4px_0_rgba(0,0,0,0.3),_8px_8px_0_rgba(0,0,0,0.2)]">
                        JADWAL
                    </h1>
                    <h2
                        class="font-sancreek uppercase text-[#fbbf24] leading-[0.85] text-3xl sm:text-4xl md:text-5xl lg:text-6xl [text-shadow:_2px_2px_0_rgba(0,0,0,0.8)]">
                        KEGIATAN
                    </h2>
                    <p class="text-white/90 text-lg sm:text-xl mt-6 max-w-3xl mx-auto">
                        Jangan lewatkan setiap momen seru di {{ $nama_event }}
                    </p>
                </div>

                <!-- Event Date -->
                <div class="bg-white/20 backdrop-blur-sm rounded-2xl p-6 max-w-md mx-auto mb-8">
                    <div class="text-[#fbbf24] font-bold text-2xl mb-2">
                        {{ \Carbon\Carbon::parse($end_event)->format('d F Y') }}</div>
                    <div class="text-white text-lg">📍 {{ $lokasi }}</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="relative w-full py-16 bg-gradient-to-b from-[#f5f5f5] to-white overflow-hidden">
        ...
        <div class="absolute inset-0 opacity-5 z-0">
            <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    <pattern id="schedulePattern" x="0" y="0" width="80" height="80"
                        patternUnits="userSpaceOnUse">
        ...
        <div class="relative container mx-auto px-4 sm:px-6 lg:px-8 z-10">
            ...
            <div class="text-center mb-12">
                <h2
                    class="font-sancreek uppercase text-[#D32F2F] text-4xl sm:text-5xl md:text-6xl mb-4 [text-shadow:_2px_2px_0_rgba(0,0,0,0.3)]">
                    Agenda Kegiatan
                </h2>
                <p class="text-gray-700 text-lg max-w-2xl mx-auto">
                    Ikuti setiap kegiatan menarik sepanjang hari di {{ $nama_event }}
                </p>
            </div>
                ...
                <div class="bg-gradient-to-r from-[#D32F2F] to-[#B71C1C] rounded-t-3xl p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <h3 class="text-2xl font-bold">{{ \Carbon\Carbon::parse($end_event)->format('d F Y') }}
                                </h3>
                                <p class="text-white/80">Pelaksanaan • {{ $lokasi }}</p>
                            </div>
                        </div>
                ...
                <div class="bg-white rounded-b-3xl shadow-2xl overflow-hidden">
                    <div class="max-h-[600px] overflow-y-auto custom-scrollbar">
                        ...
                        @foreach ($schedule as $index => $item)
                            <div
                                class="flex items-center p-4 border-b border-gray-100 hover:bg-gray-50 transition-colors duration-200 group">
                                <!-- Time -->
                                ...
                                <!-- Icon -->
                                <div
                                    class="flex-shrink-0 w-12 h-12 mx-4 rounded-full {{ $item['color'] }} flex items-center justify-center text-xl group-hover:scale-110 transition-transform duration-200">
                                    {{ $item['icon'] }}
                                </div>
                                ...
                                <div class="flex-shrink-0 ml-4">
                                    <div
                                        class="w-3 h-3 rounded-full bg-gray-300 group-hover:bg-[#D32F2F] transition-colors duration-200">
                                    </div>
                                </div>
                            </div>
                        @endforeach
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
                <!-- Duration Card -->
                <div
                    class="bg-gradient-to-br from-[#D32F2F] to-[#B71C1C] rounded-2xl p-6 text-white text-center transform hover:-translate-y-2 transition-all duration-300 shadow-xl">
                ...
                <!-- Activities Card -->
                <div
                    class="bg-gradient-to-br from-[#fbbf24] to-[#f59e0b] rounded-2xl p-6 text-white text-center transform hover:-translate-y-2 transition-all duration-300 shadow-xl">
                    <div class="text-4xl mb-4">🎪</div>
                ...
                <!-- Prize Card -->
                <div
                    class="bg-gradient-to-br from-[#4CAF50] to-[#388E3C] rounded-2xl p-6 text-white text-center transform hover:-translate-y-2 transition-all duration-300 shadow-xl">
                    <div class="text-4xl mb-4">🏆</div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                scrollButton.className =
                    'fixed bottom-6 right-6 bg-gradient-to-r from-[#D32F2F] to-[#B71C1C] text-white px-6 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 z-50 font-semibold';
