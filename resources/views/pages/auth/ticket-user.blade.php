        ...
        <div class="container mx-auto px-4 max-w-2xl">
            ...
            @if (!$ticket || $ticket->status_acc === false)
                <div class="bg-white rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.4)] p-6 mb-6">
                    ...
                    <!-- REJECTED ALERT -->
                    @if (isset($ticket) && $ticket->status_acc === false)
                        <div class="bg-red-50 border-l-4 border-red-500 p-4 mb-6 rounded-r animate-fade-in">
                            <div class="flex items-start">
                                ...
                                <div class="ml-3">
                                    <h3 class="text-sm font-bold text-red-800">Pembayaran Ditolak</h3>
                                    <div class="mt-1 text-sm text-red-700">
                                        <p>Mohon maaf, bukti pembayaran Kamu tidak valid atau tidak sesuai. Silakan
                                            unggah
