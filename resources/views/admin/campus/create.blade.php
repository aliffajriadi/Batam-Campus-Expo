        ...
        <form action="{{ route('admin.campus.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="singkatan" id="singkatan"
                        class="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                        value="{{ old('singkatan') }}" placeholder="e.g. UI">
                </div>
                <div>
                    ...
                    <select name="akreditasi" id="akreditasi"
                        ...
                        <option value="Baik Sekali" {{ old('akreditasi') == 'Baik Sekali' ? 'selected' : '' }}>Baik Sekali
                        </option>
                    </select>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="tahun_berdiri" id="tahun_berdiri"
                        class="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                        value="{{ old('tahun_berdiri') }}" placeholder="e.g. 1990">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" name="jumlah_mahasiswa" id="jumlah_mahasiswa"
                        class="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                        value="{{ old('jumlah_mahasiswa') }}" placeholder="e.g. 5000">
                </div>
                <div>
            ...
            <div>
                ...
                <input type="text" name="fakultas" id="fakultas"
                    class="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                    value="{{ old('fakultas') }}" placeholder="e.g. Engineering, Medicine, Economics">
            </div>
            ...
            <div>
                ...
                <textarea name="deskripsi" id="deskripsi" rows="4"
                    class="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                    placeholder="Brief description about the campus...">{{ old('deskripsi') }}</textarea>
            </div>
