...
<head>
    ...
    <meta name="description"
        content="Batam Campus Expo - Pameran pendidikan terbesar di Kepulauan Riau. Temukan universitas dan jurusan impian Anda.">
...
<body class="bg-transparent min-h-screen flex flex-col">
    ...
    <a href="#main-content"
        class="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 bg-[#D32F2F] text-white px-4 py-2 rounded-md z-50">
